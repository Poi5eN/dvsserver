...
const itemSchema = new mongoose.Schema({
  itemId: { type: String, default: uuidv4, required: true, unique: true },
  ...
  icon: { type: String, default: "default-icon.svg" }, // Path to SVG icon
  color: { type: String, default: "#000000" }, // Hex color code
